    ...
    <main id="contents">
            ...
            <section id="board-type" class="section center mb100">
                <div class="container">
                    ...
                    <p class="section__desc">자유롭게 글을 남길 수 있는 게시판입니다.</p>
                    <div class="board__inner">
                        <div class="board__search">
                        <form action="boardSearch.php" name="boradSearch" method="get">
                            <fieldset>
                                <legend class="ir_so">게시판 검색 영역</legend>
                                <div>
                                    <input type="search" name="searchKeyword" class="search-form" placeholder="검색어를 입력하십시오" aria-label="search" required>
                                </div>
                                <div>
                        ...
                        <div class="board__table">
                            <table class="hover">
                                ...
                                <tbody>
                                    <?php
                                        //board, boardTitle, youName, regTime, boardView
                                        // 게시판 불러올 갯수
