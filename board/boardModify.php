    ...
    <main id="contents">
            ...
            <section id="board-type" class="section center mb100">
                <div class="container">
                    ...
                    <p class="section__desc">자유롭게 글을 수정할 수 있는 게시판입니다.</p>
                                    ...
                                    <fieldset>
                                        ...
                                        <?php
                                            ...
                                            if ($result) {
                                                ...
                                                echo "<div><label for='youPass'>비밀번호</label><input type='password' name='youPass' id='youPass' placeholder='비밀번호를 입력해주세요.' required></div>";
                                            }
                                        ?>
