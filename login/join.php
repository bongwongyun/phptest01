                    ...
                    <fieldset>
                        ...
                        <div class="join-box">
                            <div class="overlap">
                                ...
                                <a href="#c" class="youEmail" onclick="emailChecking()">중복검사</a>
                            ...
                            <div class="overlap">
                                ...
                                <a href="#c" class="youNickName" onclick="nickChecking()">중복검사</a>
                            ...
                            <div class="overpass">
                                ...
                                <input type="passwordC" id="youPassC" name="youPassC" maxlength="20" placeholder="확인 비밀번호를 적어주세요!" required>
